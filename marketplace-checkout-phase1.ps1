# Ellipsis SMP Marketplace Checkout UX Phase 1
# Run this from the project root folder, the same folder that contains package.json.

$ErrorActionPreference = "Stop"

if (!(Test-Path ".\package.json")) {
  Write-Error "package.json was not found. Move this script into your project root folder first."
}

if (!(Test-Path ".\src\pages")) {
  Write-Error "src\pages folder was not found. Make sure you are in the Ellipsis SMP project root."
}

$target = ".\src\pages\CheckoutPage.tsx"
$backup = ".\src\pages\CheckoutPage.backup-before-marketplace-phase1.tsx"
...
const rankDetails = [
  {
    name: "NEON",
    price: "PHP 99",
    description: "Entry premium rank with essential quality-of-life perks.",
    includes: [
      "NEON Rank Kit",
      "/sethome 3",
      "Player warp 1",
  ...
  },
  {
    name: "AETHER",
    price: "PHP 199",
    description: "Expanded premium rank for players who want more homes, warps, and utility access.",
    includes: [
      "AETHER Rank Kit",
      "/sethome 5",
      "Player warp 2",
  ...
  },
  {
    name: "TITAN",
    price: "PHP 299",
    description: "Stronger premium rank with more utility commands and marketplace space.",
    includes: [
      "TITAN Rank Kit",
      "/sethome 7",
      "Player warp 5",
  ...
  },
  {
    name: "OVERCLOCK",
    price: "PHP 399",
    description: "High-tier rank for active players who need more commands, shops, and convenience.",
    includes: [
      "OVERCLOCK Rank Kit",
      "/sethome 9",
      "Player warp 8",
  ...
  },
  {
    name: "ASCENDANT",
    price: "PHP 499",
    description: "Top premium rank with the strongest perks, complete shop access, and unlimited fly.",
    includes: [
      "ASCENDANT Rank Kit",
      "/sethome 12",
      "Player warp 10",
  ...
  const selectedProduct = useMemo(() => {
    if (selectedCategory === "Premium Ranks") {
      return {
        ...
        description: `${selectedRankDetails.description} This rank lasts for 30 days only.`,
      };
    }
  ...
  return (
    <main className="min-h-screen bg-[#030014] px-4 py-10 text-white sm:px-6">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <section className="rounded-[2rem] border border-purple-500/25 bg-white/[0.06] p-6 shadow-[0_0_60px_rgba(168,85,247,0.18)] backdrop-blur-xl">
                ...
                (step, index) => (
                  <div
                    ...
                    className={`flex min-h-[58px] items-center justify-center rounded-2xl border px-2 py-3 text-center leading-tight ${
                      index === 0
                        ? "border-purple-300 bg-purple-500/20 text-white shadow-[0_0_28px_rgba(168,85,247,0.35)]"
            ...
            <div className="mt-8 overflow-hidden rounded-3xl border border-purple-500/20 bg-black/35">
              <div className="flex min-h-[220px] items-center justify-center border-b border-purple-500/20 bg-gradient-to-br from-black via-purple-950/30 to-black p-5">
                {categoryBanner.src && (
                  <img
                    src={categoryBanner.src}
                    alt={categoryBanner.alt}
                    className="h-52 w-full object-contain [image-rendering:pixelated]"
                  />
                )}
              </div>
              ...
              <div className="p-5">
                ...
                <div className="mt-6 rounded-3xl border border-purple-500/20 bg-black/45 p-5">
                  <p className="text-xs font-black uppercase tracking-[0.25em] text-purple-300">
                  ...
                  {selectedCategory === "Premium Ranks" && (
                    <div className="mt-5">
                      <p className="mb-3 text-sm font-black uppercase tracking-[0.18em] text-purple-200">
                      ...
                      <ul className="grid gap-2 text-sm text-gray-200 sm:grid-cols-2">
                        {selectedRankDetails.includes.map((item) => (
                          <li
                            key={item}
                            className="rounded-xl border border-purple-500/20 bg-white/[0.04] px-3 py-2"
                          >
                            • {item}
                          </li>
                        ))}
                      ...
                      <p className="mt-4 rounded-xl border border-yellow-400/25 bg-yellow-400/10 p-3 text-sm font-bold text-yellow-100">
                  ...
                  {selectedCategory === "Premium Crates" && (
                    <p className="mt-4 rounded-xl border border-blue-400/25 bg-blue-400/10 p-3 text-sm text-blue-100">
              ...
              {receiptPreviewUrl && (
                <div className="rounded-2xl border border-purple-500/20 bg-black/40 p-4">
                  ...
                  <button
                    ...
                    className="mt-3 flex w-full items-center justify-center gap-2 rounded-lg border border-red-400/30 px-3 py-2 text-sm font-bold text-red-200 hover:bg-red-400/10"
                  >
                    <X className="h-4 w-4" />
                    Remove Receipt
                  </button>
                ...
                >
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    <button
                      ...
                      className="rounded-xl border border-green-300/30 px-4 py-3 font-bold text-green-100 hover:bg-green-400/10"
                    >
                      Yes
                    </button>
                    ...
                    <Link
                      to="/marketplace"
                      className="rounded-xl border border-purple-300/30 px-4 py-3 text-center font-bold text-purple-100 hover:bg-purple-400/10"
                    >
        ...
        <div className="fixed inset-x-3 bottom-3 z-40 rounded-2xl border border-purple-500/30 bg-[#080019]/95 p-4 shadow-[0_0_35px_rgba(168,85,247,0.35)] backdrop-blur-xl lg:hidden">
          <div className="flex items-center justify-between gap-4">
            ...
            <p className="text-right text-lg font-black text-yellow-300">
              {selectedProduct.price}
            </p>
          </div>
        </div>
...
Write-Host "Updated src/pages/CheckoutPage.tsx" -ForegroundColor Green
